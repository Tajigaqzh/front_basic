...
// 这几个 symbol 组成了组件侧访问 router 的最小通道：
// useRouter/useRoute 读 routerKey/routeLocationKey，
// RouterView 通过 matchedRouteKey/viewDepthKey/routerViewLocationKey 递归传递渲染上下文。
